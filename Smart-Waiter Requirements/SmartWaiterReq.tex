...
Query restaurant information should take no longer then five seconds. Processing transactions should take no longer then 10 seconds.  
...
\item Amount of concurrent clients requesting data is variable. Will effect efficiency
\end{itemize}
